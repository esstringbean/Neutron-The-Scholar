<h1 align="center">
  <a href="https://github.com/esstringbean/Neutron-The-Scholar/blob/main/docs/logo_2.png">
    <img src="docs/logo_2.png" width="215" /></a><br>
  <b>Neutron The Scholar: Towards Fully Automated</b><br>
...
We're excited to introduce **The AI Scientist** named **Neutron The Scholar**, the first comprehensive system for fully automatic scientific discovery, enabling Foundation Models such as Large Language Models (LLMs) to perform research independently.

We provide all runs and data from our paper [here](https://drive.google.com/drive/folders/1G7A0wTqfXVa-cpexjk0oaXakaSJwffEt?usp=sharing), where we run each base model on each template for approximately 50 ideas. We *highly* recommend reading through some of the [Claude papers](https://drive.google.com/drive/folders/1Mmpz6M1FK4q8e-SewgZcUzdeD0Q2zC39?usp=sharing) to get a sense of the system's strengths and weaknesses. Here are some example papers generated by Neutron 📝:

1. [DualScale Diffusion: Adaptive Feature Balancing for Low-Dimensional Generative Models](https://github.com/esstringbean/Neutron-The-Scholar/blob/main/example_papers/adaptive_dual_scale_denoising.pdf)
2. [Multi-scale Grid Noise Adaptation: Enhancing Diffusion Models For Low-dimensional Data](https://github.com/esstringbean/Neutron-The-Scholar/blob/main/example_papers/grid_based_noise_adaptation.pdf)
3. [GAN-Enhanced Diffusion: Boosting Sample Quality and Diversity](https://github.com/esstringbean/Neutron-The-Scholar/blob/main/example_papers/gan_diffusion.pdf)
4. [DualDiff: Enhancing Mode Capture in Low-dimensional Diffusion Models via Dual-expert Denoising](https://github.com/esstringbean/Neutron-The-Scholar/tree/main/example_papers/dual_expert_denoiser.pdf) 
5. [StyleFusion: Adaptive Multi-style Generation in Character-Level Language Models](https://github.com/esstringbean/Neutron-The-Scholar/blob/main/example_papers/multi_style_adapter.pdf)
6. [Adaptive Learning Rates for Transformers via Q-Learning](https://github.com/esstringbean/Neutron-The-Scholar/tree/main/example_papers/rl_lr_adaptation.pdf)
7. [Unlocking Grokking: A Comparative Study of Weight Initialization Strategies in Transformer Models](https://github.com/esstringbean/Neutron-The-Scholar/tree/main/example_papers/weight_initialization_grokking.pdf)
8. [Grokking Accelerated: Layer-wise Learning Rates for Transformer Generalization](https://github.com/esstringbean/Neutron-The-Scholar/tree/main/example_papers/layerwise_lr_grokking.pdf)
9. [Grokking Through Compression: Unveiling Sudden Generalization via Minimal Description Length](https://github.com/esstringbean/Neutron-The-Scholar/tree/main/example_papers/mdl_grokking_correlation.pdf)
10. [Accelerating Mathematical Insight: Boosting Grokking Through Strategic Data Augmentation](https://github.com/esstringbean/Neutron-The-Scholar/tree/main/example_papers/data_augmentation_grokking.pdf)
...
<p align="center">
  <a href="https://github.com/esstringbean/Neutron-The-Scholar/blob/main/example_papers/adaptive_dual_scale_denoising/adaptive_dual_scale_denoising.pdf"><img src="https://github.com/SakanaAI/AI-Scientist/blob/main/docs/anim-ai-scientist.gif" alt="Adaptive Dual Scale Denoising" width="80%" />
</a></p>
...
We support a wide variety of models, including open-weight and API-only models. In general, we recommend using only frontier models above the capability of the original GPT-4. To see a full list of supported models, see [here](https://github.com/esstringbean/Neutron-The-Scholar/blob/main/ai_scientist/llm.py).
...
## Run Neutrons Paper Generation Experiments
...
If there is an area of study you would like Neutron to explore, it is straightforward to create your own templates. In general, follow the structure of the existing templates, which consist of:
...
If you use Neutron in your research, please cite it as follows:

```
@article{lu2024aiscientist,
  title=Neutron: Towards Fully Automated Open-Ended Scientific Discovery},
  author={AxFramework},
...
We recommend reading our paper first for any questions you have on Neutron.

**Why am I missing files when running Neutron?**
...
**How do I run Neutron for different subject fields?**
